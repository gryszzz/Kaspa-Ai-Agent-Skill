...
copy_if_present "$REPO_ROOT/READINESS_APPROVALS.md" "$STAGED_SKILL_DIR/references/repo-docs"
copy_if_present "$REPO_ROOT/READINESS_APPROVALS.md" "$STAGED_SKILL_DIR"
...
copy_if_present "$REPO_ROOT/docs/kaspa/toccata-mastery-track.md" "$STAGED_SKILL_DIR/references/repo-docs/kaspa"
copy_if_present "$REPO_ROOT/docs/kaspa/kaspa-app-lab.md" "$STAGED_SKILL_DIR/references/repo-docs/kaspa"
...
copy_if_present "$REPO_ROOT/docs/kaspa/toccata-mastery-track.md" "$STAGED_SKILL_DIR/docs/kaspa"
copy_if_present "$REPO_ROOT/docs/kaspa/kaspa-app-lab.md" "$STAGED_SKILL_DIR/docs/kaspa"
...
copy_if_present "$REPO_ROOT/research-snapshots/toccata/live-covenant-indexer-mainnet-latest.md" "$STAGED_SKILL_DIR/references/repo-docs/research-snapshots/toccata"
...
copy_if_present "$REPO_ROOT/research-snapshots/toccata/live-covenant-indexer-mainnet-latest.md" "$STAGED_SKILL_DIR/research-snapshots/toccata"
...
copy_if_present "$REPO_ROOT/scripts/toccata-protocol-drill.mjs" "$STAGED_SKILL_DIR/scripts"
copy_if_present "$REPO_ROOT/scripts/toccata-protocol-drill.test.mjs" "$STAGED_SKILL_DIR/scripts"
...
copy_if_present "$REPO_ROOT/scripts/toccata-live-covenant-export.mjs" "$STAGED_SKILL_DIR/scripts"
copy_if_present "$REPO_ROOT/scripts/toccata-zk-benchmark-check.mjs" "$STAGED_SKILL_DIR/scripts"
copy_if_present "$REPO_ROOT/scripts/toccata-app-lab.mjs" "$STAGED_SKILL_DIR/scripts"
copy_if_present "$REPO_ROOT/scripts/toccata-readiness-approvals-check.mjs" "$STAGED_SKILL_DIR/scripts"

...
Generated: 2026-09-26T16:26:33.998Z

Facts hash: `81201acd03f565983fe59c93045df8e3cb3a3ec40134d6bc22d6ff52566fd2fb`

## Verdict

- Mainnet activation: verified active at mainnet DAA 550197492, activation threshold 474165565
- Mainnet DAA observed: 550197492
- Activation DAA: 474165565
- Implementation status: PR #1000 is closed and merged against master.
- Branch status: rusty-kaspa master 01b532e8b553, toccata 0ae28f939e61.
...
Current snapshot: 2026-09-26T16:26:33.998Z

### Stable Facts

- factsHash 4713fa066387bd080e9e30bcac80de0b8b41c77544cdce96555ac3c2702acb36 -> 81201acd03f565983fe59c93045df8e3cb3a3ec40134d6bc22d6ff52566fd2fb
...
- kaspanet/rusty-kaspa heads/master: sha 98a4ccd8d200 -> 01b532e8b553.
...
- Mainnet blockdag: virtualDaaScore 474391519 -> 550197492; blockCount 1192067 -> 26412373; headerCount 1192067 -> 26412373.
- TN10 blockdag: virtualDaaScore 505007593 -> 581089398; blockCount 6478083 -> 1495726; headerCount 6478083 -> 1495726.
...
| Reference | SHA | Type |
| --- | --- | --- |
| kaspanet/rusty-kaspa heads/master | 01b532e8b553 | commit |
...
| --- | --- | --- | --- | --- | --- | --- |
| kaspanet/rusty-kaspa master | ahead | 98a4ccd8d200 -> 01b532e8b553 | 17 | 245 | Activation and P2P compatibility, Transaction and wire-format contracts, Covenants and UTXO lineage, Fee, mass, and mempool policy, RPC, WASM, and SDK surface, Wallet and PSKT construction, ZK verification and pricing, Sequencing commitments and SMT state, Node storage, pruning, and IBD, Tests, benchmarks, and operator docs | [compare](https://github.com/kaspanet/rusty-kaspa/compare/98a4ccd8d200853787f227bd4536ac540cf34957...01b532e8b553523216471682649693af92f0fd16) |
...
- **Activation and P2P compatibility:** Node operators must track the activation DAA, release line, P2P version cutoff, and one-way upgrade constraints. Matched: `Cargo.toml`, `consensus/core/src/config/params.rs`, `consensus/src/consensus/mod.rs`, `consensus/src/consensus/services.rs`, `consensus/src/model/services/seq_commit_accessor.rs`, `consensus/src/pipeline/header_processor/processor.rs`, `consensus/src/pipeline/pruning_processor/processor.rs`, `consensus/src/pipeline/virtual_processor/fork_logger.rs`.
...
- **Covenants and UTXO lineage:** UTXO-first applications must preserve covenant bindings, authorizing inputs, covenant IDs, and successor lineage. Matched: `Cargo.lock`, `Cargo.toml`, `bridge/src/kaspaapi.rs`, `consensus/benches/check_scripts.rs`, `consensus/core/src/mass/mod.rs`, `consensus/src/model/stores/virtual_state.rs`, `consensus/src/pipeline/virtual_processor/mod.rs`, `consensus/src/pipeline/virtual_processor/processor.rs`.
- **Fee, mass, and mempool policy:** Fee estimation must distinguish consensus validity from node relay policy and use current mass dimensions. Matched: `Explicitly reject coinbase transactions from mempool (#1137)`, `Cargo.lock`, `bridge/src/share_handler.rs`, `clippy.toml`, `consensus/core/src/config/params.rs`, `consensus/core/src/mass/mod.rs`, `consensus/src/consensus/services.rs`, `consensus/src/pipeline/body_processor/body_validation_in_isolation.rs`.
- **RPC, WASM, and SDK surface:** Integrators must regenerate or update client bindings and test required arguments, aliases, and serialization behavior. Matched: `fix(wasm): sighash type mapping (#1085)`, `Cargo.lock`, `Cargo.toml`, `bridge/src/kaspaapi.rs`, `consensus/client/src/parents.rs`, `consensus/core/src/hashing/wasm.rs`, `consensus/wasm/src/lib.rs`, `crypto/txscript/Cargo.toml`.
- **Wallet and PSKT construction:** Wallet construction and signing previews must preserve covenant fields, compute commitments, storage mass, and explicit fees. Matched: `Cargo.lock`, `Cargo.toml`, `wallet/bip32/src/lib.rs`, `wallet/bip32/src/xprivate_key.rs`, `wallet/core/src/lib.rs`, `wallet/keys/src/lib.rs`, `wallet/macros/src/lib.rs`, `wallet/macros/src/wallet/wasm.rs`.
...
- **Sequencing commitments and SMT state:** Lane-aware indexers and proof services must handle reorgs, pruning, inactivity shortcuts, and witness availability. Matched: `Cargo.lock`, `Cargo.toml`, `consensus/core/src/config/params.rs`, `consensus/seq-commit/src/lib.rs`, `consensus/seq-commit/tests/example_block.rs`, `consensus/seq-commit/tests/prove_lane_activity.rs`, `consensus/smt-store/examples/bench_streaming_import.rs`, `consensus/smt-store/src/lib.rs`.
- **Node storage, pruning, and IBD:** Operators must plan database migrations, resync cost, retention, pruning compatibility, and recovery procedures. Matched: `Split headers to 20 MiB chunks during IBD (#1136)`, `Cargo.lock`, `Cargo.toml`, `consensus/core/src/config/params.rs`, `consensus/core/src/errors/pruning.rs`, `consensus/core/src/mass/mod.rs`, `consensus/core/tests/db_compat.rs`, `consensus/src/consensus/mod.rs`.
- **Tests, benchmarks, and operator docs:** Changed examples, tests, and guides should become reproducible compatibility checks in downstream projects. Matched: `consensus/benches/check_scripts.rs`, `consensus/benches/parallel_muhash.rs`, `consensus/core/benches/serde_benchmark.rs`, `consensus/core/benches/tx_id_bench.rs`, `consensus/core/tests/db_compat.rs`, `consensus/pow/benches/bench.rs`, `consensus/seq-commit/tests/example_block.rs`, `consensus/seq-commit/tests/prove_lane_activity.rs`.
...
| --- | --- | --- | --- | --- |
| Mainnet blockdag | ok | kaspa-mainnet | 550197492 | 26412373 |
| TN10 blockdag | ok | kaspa-testnet-10 | 581089398 | 1495726 |

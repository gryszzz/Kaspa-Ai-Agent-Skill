...
Tier 3: Rusty Kaspa pull requests
...
3. Record PR state and base branch.
4. Record KIP state separately from implementation state.
5. Record TN10/TN12 endpoint results only as testnet evidence.
6. State what would need to be true for a mainnet claim.
